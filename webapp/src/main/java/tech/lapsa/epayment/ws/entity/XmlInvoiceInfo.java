...
public class XmlInvoiceInfo extends XmlInvoiceShort {
    ...
    @XmlAttribute
    @NotNullValue
    protected XmlInvoiceStatus status;
    ...
    public XmlInvoiceInfo(final String id, final XmlInvoiceStatus status, final Instant created, final Instant paid,
    ...
    public XmlInvoiceStatus getStatus() {
	return status;
    }

    public void setStatus(final XmlInvoiceStatus status) {
	this.status = status;
    }
